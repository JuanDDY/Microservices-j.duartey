...
SECRET_KEY = 'q^cmsb@le@h0+lrod^nh1v68=gw_5e5mc42o9=qmize2d=o8()'
...
PATH_MEA = "http://" + os.environ.get("MEASUREMENTS_HOST", "10.128.0.85") + ":" + os.environ.get("MEASUREMENTS_PORT", "8080") + "/measurements"